...
const DisciplineSchema = new mongoose.Schema({
  ...
  counselingTime: { type: String },
  counselingTopic: { type: String },
  counselingStatus: { type: String, enum: ['NONE', 'SCHEDULED', 'ACCEPTED', 'RESCHEDULE_REQUESTED', 'CONFIRMED', 'CANCELLED'], default: 'NONE' },
  parentExplanation: { type: String },
  parentExplanationDate: { type: Date },
  requestedCounselingDate: { type: Date },
  requestedCounselingTime: { type: String },
  rescheduleReason: { type: String },
  rescheduleStatus: { type: String, enum: ['NONE', 'PENDING', 'APPROVED', 'REJECTED'], default: 'NONE' },
